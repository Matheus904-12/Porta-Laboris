...
const App = () => {
  ...
  const creatorData = [
    ...
    { id: '2', name: 'Creator 2', image: require('./assets/2.png') },
    { id: '3', name: 'Creator 3', image: require('./assets/3.png') },
    { id: '4', name: 'Creator 4', image: require('./assets/4.png') },
    { id: '5', name: 'Creator 5', image: require('./assets/5.png') }
  ];
