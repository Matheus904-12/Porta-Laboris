      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          <View style={styles.card}>
            <Image source={require('./assets/defini.png')} style={styles.cardBackgroundImage} />
            <Text style={styles.cardText}>Definição</Text>
          </View>
          <View style={styles.card}>
            <Image source={require('./assets/historia.png')} style={styles.cardBackgroundImage} />
            <Text style={styles.cardText}>História</Text>
          </View>
          <View style={styles.card}>
            <Image source={require('./assets/card_bg_image.png')} style={styles.cardBackgroundImage} />
            <Text style={styles.cardText}>Reformas</Text>
          </View>
        </View>
