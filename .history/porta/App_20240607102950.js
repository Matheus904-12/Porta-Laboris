  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.menu, { transform: [{ translateX }] }]}>
        ...
        <TouchableOpacity onPress={() => openWebPage('https://example.com')} style={styles.menuItem}>
          <Text style={styles.menuItemText}>Home</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => openWebPage('https://example.com/about')} style={styles.menuItem}>
          <Text style={styles.menuItemText}>About</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => openWebPage('https://example.com/contact')} style={styles.menuItem}>
