...
const App = () => {
  ...
  const creatorData = [
    { id: '1', name: 'Creator 1', image: require('./assets/image1.png') },
    { id: '2', name: 'Creator 2', image: require('./assets/image2.png') },
    { id: '3', name: 'Creator 3', image: require('./assets/image3.png') },
    { id: '4', name: 'Creator 4', image: require('./assets/image4.png') },
    { id: '5', name: 'Creator 5', image: require('./assets/image5.png') }
  ];
