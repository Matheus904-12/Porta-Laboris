...
const App = () => {
  ...
  const creatorsData = [
    { id: '1', image: require('./assets/creator1.png'), name: 'Criador 1' },
    { id: '2', image: require('./assets/creator2.png'), name: 'Criador 2' },
    { id: '3', image: require('./assets/creator3.png'), name: 'Criador 3' }
  ];
