...
const App = () => {
  ...
  const creatorsData = [
    ...
    { id: '3', image: require('./assets/luis.jpg'), name: 'Luiz Henrique Barbosa Dias' },
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.footer}>
          ...
          <TouchableOpacity onPress={() => openModal('Endereço: R. Francisco A Zeiler, 20 - Jardim Juliana, Ferraz de Vasconcelos - SP,')} style={styles.iconTextContainer}>
