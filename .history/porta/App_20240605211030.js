...
const App = () => {
  ...
  <View style={styles.bottomSpace}></View> {/* Espaço extra para garantir que o footer não fique cobrindo o conteúdo */}
</View>
...
const styles = StyleSheet.create({
  bottomSpace: {
    height: 200, // Altura do espaço extra
  },
  ...
  footer: {
    ...
    top: 200, // Ajuste o valor conforme necessário
  },
