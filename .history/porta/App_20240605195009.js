...
import { StyleSheet, ScrollView, View, Text, TextInput, TouchableOpacity, Image, FlatList } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  carousel: {
    height: 200,
    width: screenWidth, // Ensure the carousel takes the full width
  },
  carouselImage: {
